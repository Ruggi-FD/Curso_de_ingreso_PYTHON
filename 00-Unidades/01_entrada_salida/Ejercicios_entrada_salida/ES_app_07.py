...
class App(customtkinter.CTk):
    ...
    def btn_sumar_on_click(self):
        numero_uno_a_numero = int((self.txt_operador_a.get()))
        numero_dos_a_numero = int((self.txt_operador_b.get()))
    ...
    def btn_restar_on_click(self):
        numero_tres_a_numero = int((self.txt_operador_a.get()))
        numero_cuatro_a_numero = int((self.txt_operador_b.get()))

        resultado = numero_tres_a_numero - numero_cuatro_a_numero
        alert("Resultado",resultado)
    ...
    def btn_multiplicar_on_click(self):
        ...
        numero_cinco_a_numero = int((self.txt_operador_a.get()))
        numero_seis_a_numero = int((self.txt_operador_b.get()))



        resultado = numero_cinco_a_numero * numero_seis_a_numero

        alert("Resultado",resultado)

    def btn_dividir_on_click(self):

        numero_siete_a_numero = int((self.txt_operador_a.get()))
        numero_ocho_a_numero = int((self.txt_operador_b.get()))


        resultado = numero_siete_a_numero // numero_ocho_a_numero
